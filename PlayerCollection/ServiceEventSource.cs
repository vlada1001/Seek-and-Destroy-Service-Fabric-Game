...
namespace PlayerCollection
{
    ...
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [NonEvent]
        public void ServiceMessage(StatefulService serviceContext, string message, params object[] args)
        {
            if (this.IsEnabled())
            {
                string finalMessage = string.Format(message, args);
                ServiceMessage(
                    serviceContext.Context.ToString(),
                    serviceContext.Context.ServiceTypeName,
                    serviceContext.Context.ReplicaId,
                    serviceContext.Context.PartitionId,
                    serviceContext.Context.CodePackageActivationContext.ApplicationName,
                    serviceContext.Context.CodePackageActivationContext.ApplicationTypeName,
                    serviceContext.Context.NodeContext.NodeName,
                    finalMessage);
            }
        }
